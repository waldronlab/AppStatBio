...
All are available from the [svn](https://www.bioconductor.org/packages/sva) Bioconductor package
...
pheatmap::pheatmap(ge, scale="row")
```
...
- Do linear regressions (`lm(y1 ~ x1, data=anscombe1)`)
...
[html]: http://rpubs.com/lwaldron/TrentoSession4Lecture
