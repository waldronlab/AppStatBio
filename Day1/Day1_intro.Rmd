...
![Summarized Experiment](https://github.com/Bioconductor/SummarizedExperiment/raw/master/vignettes/SE.svg)
...
* Lab Exercises
    - [random variables exercises](http://genomicsclass.github.io/book/pages/random_variables_exercises.html)

* Links
    - A built [html][] version of this lecture is available.
    - The [source][] R Markdown is also available from Github.

[html]: https://rpubs.com/lwaldron/AppStatBio2022_day1
