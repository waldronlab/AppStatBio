...
(length(which(mice.averages > (mean(x) - 1) | mice.averages > (mean(x) + 1))) / 1000) * 100
```
...
```{r, echo = TRUE}
set.seed(1)
mice.averages <- rep(NA, 10000)
for (i in 1:10000){
  mice.averages[i] <- mean(sample(x, size = 5))
}
(length(which(mice.averages > (mean(x) - 1) | mice.averages > (mean(x) + 1))) / 10000) * 100
```
...
```{r, echo = TRUE}
set.seed(1)
mice.averages.5 <- rep(NA, 1000)
for (i in 1:1000){
  mice.averages.5[i] <- mean(sample(x, size = 5))
}
set.seed(1)
mice.averages.50 <- rep(NA, 1000)
for (i in 1:1000){
  mice.averages.50[i] <- mean(sample(x, size = 50))
}
par(mfrow=c(1,2))
hist(mice.averages.5)
hist(mice.averages.50)
