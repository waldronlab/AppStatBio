---
title: "Applied Statistics for High-throughput Biology Day 2"
output: slidy_presentation
author: "Levi Waldron"
vignette: >
  %\VignetteIndexEntry{Applied Statistics for High-throughput Biology Day}
...
![workflow](http://bioconductor.org/books/3.17/OSCA.intro/images/workflow.png)

Each stage (separated by dashed lines) consists of a number of specific steps, many of which operate on and modify a SingleCellExperiment instance.
...
* t-SNE is sensitive to choices of tuning parameters
    ...
    - optimal choice of perplexity changes for different numbers of cells from the **same** sample. Here is a [good post by Nikolay Oskolkov](https://towardsdatascience.com/how-to-tune-hyperparameters-of-tsne-7c0596a18868) on this topic.
* Caveats
...
```{r, fig.cap="Principal Components Analysis of Zeisel dataset"}
...
```{r, fig.cap="t-SNE clustering of Zeisel dataset"}
...
OSCA Basics: [Chapter 4 Dimensionality Reduction](http://bioconductor.org/books/3.17/OSCA.basic/dimensionality-reduction.html)
