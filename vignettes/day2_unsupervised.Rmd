...
![Single-cell workflow](http://bioconductor.org/books/3.17/OSCA.intro/images/workflow.png)
...
```{r, fig.cap = "UMAP representation of the Zeisel dataset"}
...
* Optional if you are interested, OSCA Advanced: [Chapter 4 Dimensionality reduction, redux](http://bioconductor.org/books/3.17/OSCA.advanced/dimensionality-reduction-redux.html)
