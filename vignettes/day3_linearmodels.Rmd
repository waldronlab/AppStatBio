...
* ["Local" False Discovery Rate](https://www.huber.embl.de/msmb/06-chap.html#sec-testing-localfdr)
...
Please include discussion of the following questions:
1. What is a major problem with the hypothesis testing in [4.6 Testing for between-label differences](http://bioconductor.org/books/3.17/OSCA.multisample/multi-sample-comparisons.html#testing-for-between-label-differences)? Hint, see [Double dipping: problems and solutions, with application to single-cell RNA-sequencing data](https://stat.uw.edu/seminars/double-dipping-problems-and-solutions-application-single-cell-rna-sequencing-data)
...
3. Could some kind of multi'omic technology allow you to do these per cell type analysis without the same problems?
