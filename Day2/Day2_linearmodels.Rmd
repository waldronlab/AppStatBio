...
---
title: 'UNIVR Applied Statistics for High-throughput Biology 2018: Day 2'
author: "Levi Waldron"
date: "Mar 8, 2018"
output: 
  html_document: 
...
```{r}
spider$binfriction <- cut(spider$friction, breaks=c(0, median(spider$friction), Inf), labels=c("low", "high"))
fitbin <- glm(binfriction ~ type + leg, family = binomial(), data=spider)
summary(fitbin)
```
