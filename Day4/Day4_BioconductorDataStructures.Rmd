---
title: 'UNIVR Applied Statistics for High-throughput Biology 2019: Day 4'
author: "Levi Waldron"
date: "Jan 18, 2019"
output: 
  html_document: 
...
# Multi-omic data analysis in Bioconductor
...
knitr::include_graphics("figures/RaggedExperiment.png")
```
...
knitr::include_graphics("figures/MultiAssayExperiment.png")
```
...
knitr::include_graphics("figures/MultiAssayExperiment_cheatsheet.png")
```
...
```{r}
res <- wideFormat(miniACC[c("TP53", "CTNNB1"), , ],
           colDataCols = c("vital_status", "days_to_death"))
res[1:2, 1:7]
```
...
```{r}
miniACCsurv <- miniACC[, complete.cases(miniACC$days_to_death,
                                        miniACC$vital_status), ]
```
